  ...
  PopupTemplate, GraphicsLayer
    ...
    return declare([GraphicsLayer], {
        constructor: function (options) {
            ...
            this._singleSym = options.singleSymbol || new SMS("circle", 9, null, new Color(options.singleColor));
        ...
        _setMap: function (map, surface) {
            ...
            this._clusterGraphics(map.extent);
            ...
            this._zoomEnd = connect.connect(map, "onExtentChange", this, function () {
                ...
                this.clear();
                this.clearSingles();
                this._clusterGraphics(this._map.extent);
            });
        ...
        // internal methods 
        _clusterGraphics: function (extent) {
            ...
            for (var j = 0, jl = this._clusterData.length; j < jl; j++) {
                ...
                var x = point.x;
                var y = point.y;
                var id = point.attributes.clusterId;
                if (id != null && id != undefined) {
                    point.attributes.clusterId = "";
                }
        ...
        _showCluster: function (c) {
            ...
            if (c.attributes.clusterCount == 1) {
                var Symbol = new esri.symbol.SimpleMarkerSymbol(esri.symbol.SimpleMarkerSymbol.STYLE_CIRCLE, 8, new esri.symbol.SimpleLineSymbol(esri.symbol.SimpleLineSymbol.STYLE_SOLID, new dojo.Color("#d34607"), 1), new dojo.Color("#d34607"));
                var graphic = new Graphic(point, Symbol, c.attributes, null);
                this.add(graphic);
                return;
            }
