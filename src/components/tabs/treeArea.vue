...
export default {
        ...
        render: (h, params) => {
          ...
          return h('span', {
            ...
            on: {
              ...
              mouseover: () => {
                // $(event.currentTarget).parent().attr('id', 'area-hover')
  ...
  methods: {
      ...
      if (process.env.NODE_ENV === 'development') {
        getTreeData().then((res) => {
          ...
          if (checkedArr.length > 0) {
            this.dataList = InitCheckedArr(regionTreeData, checkedArr)
    ...
    _upDateDWJ () {
      ...
      // let codes = new Array('1000000000020792', '1000000000013989')
      let data = {
