<template>
  <div id="masterFrame" style="height: 589px;">
    <div id="div_Content" style="border: 1px solid #007ACC;border-top: 2px solid #007ACC; ">
      <div style="width:540px;float:left;margin-top: 10px;margin-left: 10px;">
        ...
        <div style="border: silver 1px solid;width: 430px;margin-top: 20px;">
...
export default {
  ...
  methods: {
        ...
        $.ajax({
          ...
          success: function (re) {
            ...
            if (re.toString() === '0') { // 当前用户密码验证失败
              ...
              my.showTheDialog(text, 3, true, '信息验证')
            }
          }
        })
    ...
    showTheDialog (val, type, isTipInput, dialogTitle) {
...
<style scoped>
  ...
  #masterFrame #div_Content p{
    font-size: 16px;
  }
  #masterFrame #div_Content .Silverp{
    color:silver;
  }
